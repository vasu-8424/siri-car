        ...
        <div className="footer__main">
          ...
          <div className="footer__brand">
            ...
            <div className="footer__socials">
              <a href="https://www.instagram.com/siri_car_rentals_5?igsh=dnlseTZnNWI1dzJn&utm_source=qr" className="footer__social" target="_blank" rel="noreferrer" aria-label="Instagram">
