    ...
    <footer className="footer">
      ...
      <div className="container">
        <div className="footer__main">
          ...
          <div className="footer__brand">
            ...
            <div className="footer__socials">
              ...
              <a href="https://wa.me/919876543210" className="footer__social footer__social--wa" target="_blank" rel="noreferrer" aria-label="WhatsApp">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a href="tel:+919876543210" className="footer__social footer__social--call" aria-label="Call">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="footer__links-group">
            ...
            <ul className="footer__links footer__links--contact">
              ...
              <li>
                <span>✉️</span>
                <a href="mailto:siricarrentals@gmail.com">siricarrentals@gmail.com</a>
              </li>
              <li>
                <span>📍</span>
        ...
        <div className="footer__bottom">
          <p>© {year} SIRI CAR RENTALS. All rights reserved. | Visakhapatnam, Andhra Pradesh</p>
